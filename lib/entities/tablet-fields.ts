...
export const TABLET_FIELDS: FieldDef<Tablet>[] = [
  ...
  { key: "Brand", label: "Brand", getValue: (t) => t.Model.Brand, type: "enum", enumValues: ["GAOMON", "HUION", "SAMSUNG", "UGEE", "WACOM", "XENCELABS", "XPPEN"], group: "Model" },
...
export const TABLET_DEFAULT_VIEW: Step[] = [
  {
    kind: "select",
    fields: [
      "Brand", "FullName", "ModelType", "ModelLaunchYear",
