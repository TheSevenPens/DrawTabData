...
export const PEN_FIELDS: FieldDef<Pen>[] = [
  ...
  { key: "Brand", label: "Brand", getValue: (p) => brandName(p.Brand), type: "enum", enumValues: [...BRANDS], group: "Pen" },
  ...
  { key: "Tags", label: "Tags", getValue: (p) => (p.Tags ?? []).join(', '), type: "string", group: "Pen" },
