...
const BrandEnum = v.picklist(["APPLE", "ASUS", "DIGIDRAW", "GAOMON", "HUION", "LAMY", "SAMSUNG", "STAEDTLER", "UGEE", "VEIKK", "WACOM", "XENCELABS", "XPPEN"]);
...
const ModelSchema = v.strictObject({
  ...
  ReleaseYear: TrimmedString,
  // Exact release date when known, ISO-8601 with variable precision:
  // "YYYY-MM-DD", "YYYY-MM", or "YYYY". ReleaseYear stays the canonical
